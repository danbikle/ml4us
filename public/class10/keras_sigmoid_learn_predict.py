...
fn_s = 'keras_sigmoid_predictions.csv'
os.system('rm -f '+fn_s)
...
col_iwant_l = [3,4,5,10,15,17,19,22,23]
# try this:
...
for yr_i in range(2010,lastyr2predict_i+1):
    ...
    kmodel.fit(x_a, y_a, batch_size=32, epochs=128)
    xtest_a        = test_a[:,1:]
